...
const PROVINCIAL_REGIONS = new Set(['Alberta', 'Alberta-wide', 'Airdrie', 'Beaumont', 'Brooks', 'Calgary', 'Camrose', 'Chestermere', 'Cold Lake', 'Edmonton', 'Fort McMurray', 'Grande Prairie', 'Fort Saskatchewan', 'Lacombe', 'Leduc', 'Lethbridge', 'Lloydminster', 'Medicine Hat', 'Okotoks', 'Red Deer', 'Sherwood Park', 'Spruce Grove', 'St. Albert', 'Wetaskiwin']);
