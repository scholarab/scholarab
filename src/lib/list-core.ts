...
const PROVINCIAL_REGIONS = new Set(['Alberta', 'Alberta-wide', 'Airdrie', 'Beaumont', 'Brooks', 'Calgary', 'Chestermere', 'Edmonton', 'Fort Saskatchewan', 'Leduc', 'Lethbridge', 'Lloydminster', 'Medicine Hat', 'Red Deer', 'Spruce Grove', 'St. Albert']);
