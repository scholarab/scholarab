 ...
 * fourteen cities put a 17-option question in front of Medicine Hat, Lethbridge
 * and Airdrie students, who had no school question at all, to filter three
 * listings out of 537. A student at one of those schools is in a town that is
 * not one of the fourteen named cities, so "Other Alberta" is the answer they give,
