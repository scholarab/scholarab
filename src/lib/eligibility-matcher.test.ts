...
describe('the corpus the quiz matches against', () => {
  ...
  it('leaves no scholarship that no profile can reach', async () => {
    ...
    const cities = ['Airdrie', 'Beaumont', 'Brooks', 'Calgary', 'Camrose', 'Chestermere', 'Cold Lake', 'Edmonton', 'Fort Saskatchewan', 'Lacombe', 'Leduc', 'Lethbridge', 'Lloydminster', 'Medicine Hat', 'Red Deer', 'Spruce Grove', 'St. Albert', 'Other Alberta']
