...
The web fonts in `public/fonts/` (Big Shoulders, Public Sans, Patrick Hand) and `scripts/og-fonts/` are the work of their respective authors under the SIL Open Font License 1.1, and are covered by neither license above. Notices and full license text: [`public/fonts/OFL.txt`](./public/fonts/OFL.txt).

The images in `public/photos/` are also covered by neither license. Each keeps its own terms; sources are in [`public/photos/CREDITS.md`](./public/photos/CREDITS.md).
